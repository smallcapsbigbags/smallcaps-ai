...
def build_fingerprint() -> str:
    ...
    for name in ('api/rnsrepo_public.py', 'api/paste.py', 'api/paste_jobs.py',
                 'rnsrepo/public_access.py', 'rnsrepo/extractor.py', 'rnsrepo/citations.py', 'rnsrepo/sections.py', 'rnsrepo/schema.py', 'rnsrepo/financial_context.py', 'rnsrepo/source_context.py', 'rnsrepo/validation.py', 'product/paste.py',
